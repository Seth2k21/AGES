	...
	<section class="page-info-section">
		<div class="container">
			...
			<div class="site-beradcamb">
				...
				<a href="blog.php"><span><i class="fa fa-angle-right"></i>Services</span></a>
			</div>
		</div>
	</section>
	<!-- Page info end -->
...
country.
	 ...
	 <div class="row mt-5 fixed">
		      ...
		      <div class="row mt-5 fixed">
						<div class="col-md-6">
							<div class="blog-item">
								<figure class="blog-thumb">
									<img src="img/jeunee.jpeg" alt="" height="370px">
								</figure>
								<div class="blog-text">
	...
	<!-- Newsletter section -->
	<section class="newsletter-section gradient-bg mt-5">
