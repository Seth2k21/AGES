...
<h5>Political instability which could limit access to state tenders.</h5> 
	...
	<section class="fact-section gradient-bg w-100 rounded-4">
		<div class="container text-center">
				
					<div class="fact">
						<h1 style="color: yellow;">99</h1>
						<p style="font-size: 25px;">Years <br>upon registration with the RCCM</p>
						<i class="ti-pencil"></i>	
			       </div>
				...
				<div class="col-md-6 col-lg-2 offset-lg-1 footer-widget">
					...
					<ul>
					  <a href="contactp#section2">send us your message</a>
						...
						<a href="indexsection0">Our Features</a>
